...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-gnome-shell-style-wincity"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-gnome-shell-style-wincity/iso-profile
"
echo
